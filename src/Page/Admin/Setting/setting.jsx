            ...
            <div className="col-md-6 col-xl-4">
              <div className="card shadow-sm border-0 h-100">
                <div className="card-body text-center">
                  <h5 className="card-title mb-1">Mã QR đặt món</h5>
                  <p className="text-secondary mb-3">
                    In mã này và dán lên bàn để khách quét, đăng ký và bắt đầu đặt món.
                  </p>
                  <img
                  ...
                  <div>
                    <a
                      href={`${window.location.origin}/user/register`}
                      target="_blank"
                      rel="noreferrer"
              ...
              <div className="card" style={{ width: 520 }}>
                <div className="card-body">
                  ...
                  <form onSubmit={async (e) => {
                    ...
                    else if (newPass === currentPass) err.new = 'Mật khẩu mới phải khác mật khẩu hiện tại.';
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div>
                        <button type="button" className="btn btn-outline-secondary me-2" disabled={submitting} onClick={() => { setShowChange(false); setErrors({}); }}>Hủy</button>
